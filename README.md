...
cd gke-review-apps-delivery-workshop
```
...
Google Cloud Run is a serverless platform that lets you run your code in containers without managing any servers. It automatically scales your application up or down based on demand, so you only pay when your code is running.  Just package your code in a container, give it to Cloud Run, and let Google handle the rest!
...
Google Cloud Secret Manager is a service that allows you to store and manage sensitive data, such as API keys, passwords, and certificates, securely in the cloud. It's like a vault for your secrets, helping you protect them and control access.
